...
const styles: Record<DemoStatus,string> = {
  Passed:"bg-teal-100 text-teal-800", Failed:"bg-red-100 text-red-700", Running:"bg-blue-100 text-blue-700", Untested:"bg-slate-200 text-slate-600", Skipped:"bg-slate-100 text-slate-500"
};
