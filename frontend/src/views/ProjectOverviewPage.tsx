      ...
      <PageHeader
        ...
        actions={
          <>
            ...
            <Link to={`/projects/${project.id}/suites`} className="rounded-lg bg-indigo-600 px-4 py-2 text-sm font-medium text-white">
              View Test Suites
            </Link>
          </>
        }
        ...
        {project.suitesList.map((suite) => (
          <div key={suite.id} className="rounded-lg bg-white p-5 shadow-sm">
            ...
            <div className="mt-3 flex justify-end gap-2">
              ...
              <Link to={`/projects/${project.id}/runs/104/live`} className="rounded-lg bg-indigo-50 px-3 py-1.5 text-sm font-medium text-indigo-700">
                <Play size={13} className="mr-1 inline" /> Run Suite
              </Link>
            </div>
          </div>
        ))}
